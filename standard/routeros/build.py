...
DEFAULT = {
    ...
    'url': 'https://github.com/parhamfa/mikrowarp/releases/download/r14-standard/mikrowarp-standard-r14-linux-amd64.tar.gz',
    'revision': 'r14-standard',
}
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output', type=Path, default=ROOT / 'deploy/mikrotik/mikrowarp.rsc')
